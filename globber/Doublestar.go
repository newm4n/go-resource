// Package doublestar is taken from
...
// is the IsPathMatch() function below.
//
func Match(pattern, name string) (bool, error) {
	return matchWithSeparator(pattern, name, '/')
}

// IsPathMatch is like Match except that it uses your system's path separator.
...
//
func IsPathMatch(pattern,  name string) (bool, error) {
